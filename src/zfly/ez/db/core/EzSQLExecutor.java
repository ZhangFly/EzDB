...
import zfly.ez.db.helper.SimpleConnectionPool;
 ...
 * @author YFei
 */
public class EzSQLExecutor {

    private static Logger log = Logger.getLogger(EzSQLExecutor.class);
     ...
     * @throws SQLException
     */
    EzSQLExecutor(final int size, final String url, final String usr, final String pwd) throws SQLException {
     ...
     * @throws SQLException
     */
    public void doExecute(final String sql, final EzDBHandler handler) throws SQLException {
